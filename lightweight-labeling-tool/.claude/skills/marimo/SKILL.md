---
name: marimo
description: Helpful assistant for building notebooks with Marimo.
---
...
@app.cell def _(): mo.md(""" # Hello world This is a _markdown cell. """) return
</example>
...
@app.cell def _(): n_points = mo.ui.slider(10, 100, value=50, label="Number of points") n_points return
