...
| v0.3 (started) | ~~Dataset export filtered by contract~~ (done: `export.py`, replay-reconstructed observations, invariant-gated rewards); LLM-judge verifier; structured ModelPolicy turns; OTel spans; `orrery qa` CI gate | Evaluating real agents at fidelity; fine-tuning data; QA-at-release-speed |
