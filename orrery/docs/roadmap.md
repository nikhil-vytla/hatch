...
| v0.3 | LLM-judge verifier (ground-truth-aware); dataset export (SFT pairs / RL trajectories filtered by contract); `orrery qa` CI gate; invariant-vs-objective reporting | Evaluating real agents at fidelity; fine-tuning data; QA-at-release-speed |
