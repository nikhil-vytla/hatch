...
load-bearing ideas and their limits, to inform Orrery's abstractions.
...
## Synthesis → what Orrery must do differently

1. **A real world model.** All four systems evaluate *conversations or episodes*;
   none has shared, hidden, evolving world state. Orrery's core is an event-sourced
