...
windtunnel run worlds/support_desk.toml --seed 42 --out runs/
windtunnel run --generate support_desk --seeds 20        # population QA
windtunnel replay worlds/support_desk.toml runs/support_desk-42.jsonl
windtunnel generate support_desk --seed 7 --out spec.json
"""
...
from windtunnel.plugins import build_registry
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="windtunnel")
    ...
    p_run.add_argument("--uses", action="append", default=["windtunnel.domains.support"])
    ...
    p_gen.add_argument("--uses", action="append", default=["windtunnel.domains.support"])
