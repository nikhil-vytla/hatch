...
from windtunnel.models import ModelResponse, PlaybookClient
from windtunnel.plugins import build_registry
from windtunnel.spec import PolicySpec, WorldSpec
...
def model_driven_support_spec() -> WorldSpec:
    ...
    registry = build_registry(uses=["windtunnel.domains.support"])
