...
| ADR | Title | Status |
|---|---|---|
| [0008](0008-vnext-substrate.md) | vNext: policy-neutral revision-native substrate | **accepted, implemented (Phase A)** — one append-only event/artifact substrate + a resumable policy command boundary; comparative evaluation is an optional `EvaluateFork` mechanism, not a gate; `manual-change@1` proves apply/observe/checkpoint/revert. Supersedes the promotion premise of 0004/0005 |
