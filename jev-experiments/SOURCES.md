...
- [RewardBench 2](https://huggingface.co/datasets/allenai/reward-bench-2/tree/7ff08853b0d5686e79b13fda8677024f566a104a): experiment 28 now scores the full 1,865-case test split with Jev against upstream chosen/rejected labels. The app exposes candidate text, source attribution, the exact rubric, and the separate Ties formula. [Method and audit](rewardbench2/README.md).
- [IFEval](https://github.com/google-research/google-research/tree/master/instruction_following_eval): archived writing-selection pilot, superseded in the public app by RewardBench 2. Its executable instruction checks remain historical measurements and do not establish creative-writing quality.
