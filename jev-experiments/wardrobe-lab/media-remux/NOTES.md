...
- Root confirmed the canonical deployment8c208b5serves both exact remuxed SHA256 values. Actual app playback reports spoken duration/seekable range29.954s, plays after seeking to20s and seeks backward to4s, at720×1280 withreadyState4and no error or overflow. The first automation attempt selected the hidden live-camera video instead of the recorded video; correcting the selector resolved that test setup issue. See production-browser.json and ../output/production-spoken-video.png.
