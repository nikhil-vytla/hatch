...
3. Open the companion popup. Under Connection, enter `https://jev-experiments.vercel.app` and your private lab access token. Click Connect and grant access to this lab origin.
