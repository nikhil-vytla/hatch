...
Recording in progress: 3,931/7,440 evaluation records, covering 7,859/14,880 independent question decisions. The frozen study includes all 620 released response pairs, both orders, three unchanged pairwise passes, pair-context whole-answer scoring, and isolated-candidate whole-answer scoring. All scores below are provisional until coverage is complete. Missing evaluations are retained in planned denominators and availability is shown separately.

## Design and source

[JudgeBench](https://github.com/ScalerLab/JudgeBench/tree/e2c52c284e735e139b3daa61c206ee208f36c461) supplies 350 GPT-4o pairs and 270 Claude 3.5 Sonnet pairs. These are 620 candidate pairs from 268 source-question clusters, with 308 MMLU-Pro, 239 LiveBench and 73 LiveCodeBench pairs. The source commit is pinned to `e2c52c284e735e139b3daa61c206ee208f36c461`; manifest.json stores source-file SHA-256 values, complete input hash, protocol hash and maximum input size. cases.jsonl contains the full original question and both answers plus provenance and content triage. No candidate generation or model training occurred.
...
| 2 | 58.87% | 54.52% | 74.86% | 76.47% | 208/620 |
| 3 | 0.00% | 0.00% | unavailable | unavailable | 0/620 |
...
| --- | ---: | ---: | ---: | ---: |
| gpt-4o-2024-05-13 | 350 | 44.57% | 38.95% | 78.18% |
| claude-3-5-sonnet-20240620 | 270 | 38.02% | 33.83% | 71.59% |

| Method | Complete 3-pass sets | Answer identity flips | Tie transitions | Nonzero score drift | Mean score range |
| --- | ---: | ---: | ---: | ---: | ---: |
| pairwise | 0/1240 | 0 | 0 | 0 | unavailable |
| shared | 0/1240 | 0 | 0 | 0 | unavailable |
| isolated | 0/620 | 0 | 0 | 0 | unavailable |
...
| --- | ---: | ---: | ---: | --- |
| pairwise_official | 0 | 0 | unavailable | unavailable to unavailable |
| shared_official | 0 | 0 | unavailable | unavailable to unavailable |
| isolated_accuracy | 0 | 0 | unavailable | unavailable to unavailable |
| pairwise_minus_shared_official | 0 | 0 | unavailable | unavailable to unavailable |
| pairwise_minus_isolated_ordered | 0 | 0 | unavailable | unavailable to unavailable |
...
616 native batches returned 7,859 question decisions across 988 network attempts. 372 attempts were unsuccessful, 2 logical batch invocations exhausted transient retries, and 0 nontransient failures were retained. Median successful-batch latency was 498ms and the 95th percentile 45813ms, including internal retries. The observed window is 2026-09-20T20:05:27.680Z to 2026-09-20T21:45:14.308Z. Returned model aliases: typesafe-ai/jev. The provider did not expose a separate immutable model revision. Reported cost is $0; a zero metadata value is not a billing audit.
