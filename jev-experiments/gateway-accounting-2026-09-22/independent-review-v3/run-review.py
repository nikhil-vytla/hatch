...
def main() -> int:
    ...
    commands = [("maintained", ["bun", "test", *MAINTAINED_TARGETS]),
                ("independent-boundaries", ["bun", "test", str(review / REVIEW_TARGET)])]
    if VERSION == "v2":
